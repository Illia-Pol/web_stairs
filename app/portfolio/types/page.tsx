...
export default function TypesPage() {
  ...
  const breadcrumbs = [
    ...
    { name: tr("breadcrumb_current"), href: "/portfolio/types" }
  ];
        ...
        <Container>
          ...
          <div className="info-grid mt-6">
            <article className="guarantee-card">
              <h2>Как выбрать тип лестницы без ошибок</h2>
              <p>
                Выбор начинается не с картинки, а с геометрии и сценария использования. Один и тот же визуально красивый вариант может быть неудобным
                или рискованным на конкретном объекте, если не учтены высота, шаг, зона разворота и будущая отделка.
              </p>
              <ul className="guarantee-list">
                <li>Сначала проверяем фактические размеры проема и высоту между этажами</li>
                <li>Затем подбираем тип по удобству ежедневной эксплуатации</li>
                <li>После этого уточняем бюджетный диапазон и формат работ</li>
                <li>Только потом фиксируем финальную конфигурацию и узлы</li>
              </ul>
            </article>
            <article className="guarantee-card">
              <h2>Classic и Signature для разных типов</h2>
              <p>
                Тип лестницы и формат работы связаны между собой. Базовые монолитные и П-образные решения чаще рациональны в Classic, а консольные и
                парящие чаще требуют Signature из-за инженерной сложности и требований к точности.
              </p>
              <div className="mt-4 flex flex-wrap gap-3">
                <Link href="/prices/calculator" className="btn btn-small">
                  Открыть калькулятор Classic
                </Link>
          ...
          <article className="guarantee-card mt-6">
            <h2>FAQ по выбору типа лестницы</h2>
            <div className="grid gap-4 md:grid-cols-2 mt-4">
              {[
                {
                  q: "Как понять, какой тип подойдет именно моему дому?",
                  a: "По фактическим размерам проема, высоте между этажами, желаемой эргономике и стилю интерьера. Мы подбираем не «в вакууме», а под реальную задачу."
                },
                {
                  q: "Можно ли выбрать тип только по фото из интернета?",
                  a: "Можно выбрать визуальное направление, но финальное решение принимается только после технической проверки объекта."
                },
                {
                  q: "Что чаще всего влияет на смену типа уже в процессе?",
                  a: "Выясненные ограничения проема, требования к отделке и инженерные узлы, которые не были учтены в начале."
                },
                {
                  q: "Можно ли заранее понять диапазон бюджета по типу?",
                  a: "Да, для этого есть ориентиры на страницах типов и калькулятор Classic. Финальную смету фиксируем после уточнения вводных."
                },
                {
                  q: "Если объект сложный, куда смотреть дальше?",
                  a: "Откройте раздел «Проблемы и решения», затем Signature-тариф и отправьте заявку с фото/планом."
                },
                {
                  q: "Вы выполняете отделку после бетона?",
