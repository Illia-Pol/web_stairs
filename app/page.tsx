        ...
        <div className="container">
          ...
          <div className="portfolio-footer reveal-up">
            <p>
              ...
              <Link className="inline-link" href="/portfolio/projects">{thp("footer_link_projects")}</Link>,{" "}
              {thp("footer_line_middle")}{" "}
              <Link className="inline-link" href="/vlog/projects">{thp("footer_link_vlog")}</Link>{" "}
              {thp("footer_line_end")}{" "}
      ...
      <section className="section section-accent" id="guarantee">
        <div className="container guarantee-wrap">
          <article className="guarantee-card reveal-up">
            ...
            <Link className="btn btn-small" href="/prices/guarantee">{thg("guarantee_button")}</Link>
          </article>

          <div className="master-photo-card reveal-up delay-1">
            <div className="master-photo">
              <img src={assetPath("/assets/master.jpg")} alt={thg("master_alt")} width={1536} height={1024} loading="lazy" decoding="async" />
            </div>
