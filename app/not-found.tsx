    ...
    <Section>
      <Container>
        <div className="rounded-xl2 border border-slate-200 bg-white p-8 text-center shadow-soft">
          ...
          <h1 className="mt-2 font-heading text-4xl uppercase text-coal">Страница не найдена</h1>
          <p className="mt-3 text-sm text-slate-600">Проверьте адрес или вернитесь на главную.</p>
